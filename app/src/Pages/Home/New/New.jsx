    ...
    return (
        <div className='py-10'>
            ...
            <div className='flex flex-wrap gap-6 justify-center py-10 px-4'>
                ...
                <div className='bg-black w-90 md:w-[400px] h-[440px] bg-center text-white flex flex-col justify-end p-4' style={{ backgroundImage: `url(${ps5})`, backgroundSize: 'cover' }}>
                ...
                <div className='flex flex-col gap-6 w-full md:w-auto'>
                    ...
                    <div className='bg-black text-white flex flex-col justify-end p-4 bg-center bg-no-repeat w-80 md:w-100 h-60'
                    ...
                    <div className='flex flex-wrap md:flex-nowrap gap-6'>
                        ...
                        <div className='bg-black text-white flex flex-col justify-end p-4 bg-center bg-no-repeat w-47 md:w-47 h-45' style={{ backgroundImage: `url(${a})`, backgroundSize: 'cover' }}>
                        ...
                        <div className='bg-black text-white flex flex-col justify-end p-4 bg-center bg-no-repeat w-47 md:w-47 h-45' style={{ backgroundImage: `url(${s})`, backgroundSize: 'cover' }}>
