...
const Wishlist = () => {
    ...
    const { totalWishlist, remove, moveAllToBag, wishlist } = useContext(CardData)
        ...
        <div className='px-20 py-10'>
            {wishlist.length === 0
                ...
                <div className="text-center text-gray-500 mt-10 space-y-4 h-screen">
                    <p>Your wishlist is empty. Browse and save items you like!</p>
                    <button
                        onClick={() => navigate('/')}
                ...
                <div>
                    <div className='flex flex-wrap md:flex-nowrap gap-10 justify-between items-center'>
                        ...
                        <button className='border-1 border-[#a4a1a1] text-[10px] px-4 py-2 rounded-[4px]' onClick={moveAllToBag}>Move All To Bag</button>
                    </div>
                    <div>
