...
const Cart = () => {
  ...
  const { cart, setCart, deleteFun, EditDecrement, EditIncrement, total, updateOderHistory } = useContext(CardData)
            ...
            <div className="px-4 md:px-10 lg:px-20 flex flex-col gap-10 py-10">
              <div className="flex flex-col justify-center w-full">
                ...
                {Array.isArray(cart) && cart.map((item) => (
                  <div className="flex items-center justify-around pb-4" key={item?.id}>
              ...
              <div className="flex flex-wrap gap-6 justify-between">
                ...
                <div className="flex flex-col gap-4 border-2 border-gray-300 w-full md:w-96 p-6 rounded-md">
                  ...
                  <button className="bg-[#DB4444] w-full py-3 text-white rounded-md text-lg" onClick={() => {
                    navigate('/checkout')
                    updateOderHistory()
                  }
                  }>
